...
| File | Board |
|------|-------|
| `levoit-core400s-builder.yaml` | original ESP32-SOLO-1C |
| `levoit-core400s-builder-c3.yaml` | ESP32-C3 replacement |
| `levoit-core400s-builder-s3.yaml` | ESP32-S3 replacement |
